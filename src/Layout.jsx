      ...
      <nav className=" border-gray-200 dark:bg-gray-900 dark:border-gray-700 bg-black">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
          ...
          <div
            ...
            id="navbar-dropdown"
          >
            <ul className="flex flex-col font-medium p-4 md:p-0 bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <button
